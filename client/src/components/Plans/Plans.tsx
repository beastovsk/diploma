	...
	return (
		<div className={s.container}>
			...
			<div className={s.content}>
				{plan === 0
					? firstPlan.map(
							({ descs, oldPrice, price, speed, title }) => (
								<div className={s.item} key={title}>
									...
									<button
										...
										className={`${s.planButton} ${s.button} ${s.activeButton}`}
									>
										Подключить
									</button>
								</div>
			...
			<h3>
				* Подключение на тарифный план Единый-M возможно только в
			...
			<div className={s.qa}>
				...
				<p>
					Не знаешь какой тариф выбрать? Ответьте на пару вопросов -
					мы подскажем
				</p>
				{step === 0 ? (
					<div>
							...
							>
								<Space direction="vertical">
									<Radio value="Просматривать веб-страницы, соц сети и электронную почту">
										Просматривать веб-страницы, соц сети и
										электронную почту
									</Radio>
									<Radio value="Смотреть видео и фильмы онлайн">
										Смотреть видео и фильмы онлайн
									</Radio>
									<Radio value="Играть по сети">
										Играть по сети
									</Radio>
									<Radio value="Для работы или учебы из дома">
										Для работы или учебы из дома
									</Radio>
								</Space>
							</Radio.Group>
						</div>
				...
				{step === 2 ? (
					<div>
						<h2 className={s.subtitle}>
							Оставьте свой контакт, мы проконсультируем Вас
						</h2>
						<Form
